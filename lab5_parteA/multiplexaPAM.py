...
class multiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 200000
        ...
        self._LPF_range = Range(0, 1000, 10, 100, 200)
        self._LPF_win = RangeWidget(self._LPF_range, self.set_LPF, "frecuencia corte filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.blocks_delay_3, 0), (self.ModulacionPAM_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.LPF, 1000, window.WIN_HAMMING, 6.76))
    ...
    def set_d4(self, d4):
        self.d4 = d4
        self.blocks_delay_3.set_dly(int(self.d4))
