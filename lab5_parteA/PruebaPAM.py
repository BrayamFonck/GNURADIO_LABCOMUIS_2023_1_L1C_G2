...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "modulacion_pulsos", catch_exceptions=True)
        ...
        # Variables
        ##################################################
        self.samp_rate2 = samp_rate2 = int(12500000/16)
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "frecuencia mensajes", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._D_win = RangeWidget(self._D_range, self.set_D, "ancho pulsos", "counter_slider", int, QtCore.Qt.Horizontal)
