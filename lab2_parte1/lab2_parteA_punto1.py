...
# Author: Daniela_Cabrales_Brayan_Fonseca_L1C_G2
# Copyright: Daniela_Cabrales_Brayan_Fonseca_L1C_G2
...
class lab2_parteA_punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_parteA_punto1")
        ...
        self._A_range = Range(0, 1, 100e-6, 500e-3, 200)
...
def main(top_block_cls=lab2_parteA_punto1, options=None):
