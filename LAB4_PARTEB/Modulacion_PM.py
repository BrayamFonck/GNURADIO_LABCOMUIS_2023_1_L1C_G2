...
from Envolvente_compleja_L1C import Envolvente_compleja_L1C  # grc-generated hier_block
...
class Modulacion_PM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Modulacion_PM")
        ...
        self.Envolvente_compleja_L1C_0 = Envolvente_compleja_L1C(
            ac=ac,
            kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_compleja_L1C_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.Envolvente_compleja_L1C_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_L1C_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Envolvente_compleja_L1C_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_compleja_L1C_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.Envolvente_compleja_L1C_0.set_kp(self.kp)
    ...
    def set_ac(self, ac):
        self.ac = ac
        self.Envolvente_compleja_L1C_0.set_ac(self.ac)
