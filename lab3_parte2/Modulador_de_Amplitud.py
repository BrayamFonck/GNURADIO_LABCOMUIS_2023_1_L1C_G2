...
# Author: Brayan_Daniela_L1C_G2
# Copyright: Brayan_Daniela_L1C_G2
...
from ModuladorAM_L1C_G2 import ModuladorAM_L1C_G2  # grc-generated hier_block
...
class Modulador_de_Amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_win = RangeWidget(self._samp_rate_range, self.set_samp_rate, "Amplitud del mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/edacecar_bbc_trenes.wav', True)
        self.blocks_complex_to_real_1 = blocks.complex_to_real(1)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.audio_sink_0 = audio.sink(samp_rate, '', False)
        self.ModuladorAM_L1C_G2_0 = ModuladorAM_L1C_G2(
            Ac=Ac,
            ka=ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorAM_L1C_G2_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.ModuladorAM_L1C_G2_0, 0), (self.blocks_complex_to_real_1, 0))
        self.connect((self.ModuladorAM_L1C_G2_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModuladorAM_L1C_G2_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuladorAM_L1C_G2_0, 0), (self.uhd_usrp_sink_0, 0))
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.ModuladorAM_L1C_G2_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.ModuladorAM_L1C_G2_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModuladorAM_L1C_G2_0.set_Ac(self.Ac)
