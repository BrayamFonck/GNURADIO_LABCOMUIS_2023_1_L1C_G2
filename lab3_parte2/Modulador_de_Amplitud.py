...
class Modulador_de_Amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ka_range = Range(0, 5, 0.01, 1, 200)
        ...
        self._k_win = RangeWidget(self._k_range, self.set_k, "Habilitar portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuladorAM_L1C_G2_0, 0))
